...
@interface LCForgetPasswordViewController ()<UITextFieldDelegate>
...
- (IBAction)confirmClick {
    ...
    [LCUserViewModel resetPasswordWithAccount:self.phoneNoField.text
                            password:self.passwordField.text
                               vcode:self.verifyField.text
                             success:^(LCUser *user) {
...
- (void)getVerifyClick{
    ...
    __weak typeof(self) weakSelf = self;
    [NetworkTool POST:API_ResetPasswdSMS parameters:@{@"phoneNo" : self.phoneNoField.text}  showHUD:YES hudView:nil hudStr:nil success:^(id data) {
        weakSelf.token = @"9999";
